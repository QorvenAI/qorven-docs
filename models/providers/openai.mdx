---
title: "OpenAI"
description: "Configure OpenAI as an LLM backend for your Qors. Setup, models, rate limits, common issues."
sidebarTitle: "OpenAI"
icon: "sparkles"
---

<div className="mb-6 flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 px-4 py-3">
  <img src="/images/logos/providers/openai.svg" alt="OpenAI logo" width={40} height={40} />
  <div>
...
<Steps>
  <Step title="Get credentials from OpenAI">
    Create an API key in the OpenAI console.
  </Step>
  <Step title="Add the key in Qorven">
    **Settings → Provider Keys → Add provider → OpenAI → paste key → Save.**
