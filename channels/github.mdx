---
title: "GitHub"
description: "Connect GitHub to your Qor. Setup, webhook URL, message shape, common issues."
sidebarTitle: "GitHub"
icon: "github"
---

<div className="mb-6 flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 px-4 py-3">
  <img src="/images/logos/channels/github.svg" alt="GitHub logo" width={40} height={40} />
  <div>
...
|---|---|
| **Family** | non-chat |
| **Setup source** | GitHub app |
| **Inbound** | Webhook / long-poll / socket — see below |
| **Outbound** | `qorven channels send --channel github` or auto-reply from the agent loop |
