...
description: "Connect Facebook Messenger to your Qor. Setup, webhook URL, message shape, common issues."
...
<div className="mb-6 flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 px-4 py-3">
  <img src="/images/logos/channels/facebook.svg" alt="Facebook Messenger logo" width={40} height={40} />
  <div>
    <div className="text-sm font-semibold">Facebook Messenger</div>
  </div>
</div>
...
| **Outbound** | `qorven channels send --channel facebook` or auto-reply from the agent loop |
